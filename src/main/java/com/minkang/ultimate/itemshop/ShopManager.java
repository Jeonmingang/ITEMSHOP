...
public class ShopManager {
    ...
    public void save() {
        ...
        for (java.util.Map.Entry<String, String> e : npcLinks.entrySet()) {
    ...
    public boolean exists(String name) {
        return shops.containsKey(name.toLowerCase(java.util.Locale.ROOT));
    }

    public Shop get(String name) {
        return shops.get(name.toLowerCase(java.util.Locale.ROOT));
    }
    ...
    public boolean delete(String name) {
        return shops.remove(name.toLowerCase(java.util.Locale.ROOT)) != null;
    }
    ...
    public java.util.Map<String, String> getNpcLinks() {
        return npcLinks;
    }
}
